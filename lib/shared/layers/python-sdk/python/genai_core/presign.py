...
UPLOAD_S3_TRANSFER_ACCELERATION = (
    os.environ.get("UPLOAD_S3_TRANSFER_ACCELERATION") == "TRUE"
)
...
def resolve_s3_endpoint():
    return (
        ...
        if UPLOAD_S3_TRANSFER_ACCELERATION
        else f"s3.{UPLOAD_BUCKET_REGION}.amazonaws.com"
    )
